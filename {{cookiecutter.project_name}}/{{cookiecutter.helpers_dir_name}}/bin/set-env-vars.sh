...
export TFINIT_DOCKER_IMAGES_DEPLOYMENT_DIR="${TFINIT_MANAGEMENT_DEPLOYMENTS_DIR}/{{cookiecutter.docker_images_deployment_name}}"
export TFINIT_GITHUB_DEPLOYMENTS_DIR="${TFINIT_DEPLOYMENTS_DIR}/{{cookiecutter.github_deployments_dir_name}}"
export TFINIT_GITHUB_ACTIONS_SECRETS_DEPLOYMENT_DIR="${TFINIT_GITHUB_DEPLOYMENTS_DIR}/{{cookiecutter.github_secrets_deployment_name}}/{{cookiecutter.project_owner}}/{{cookiecutter.project_name}}/{{cookiecutter.github_secrets_deployment_name}}"
